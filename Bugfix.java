...
public class Bugfix {
	...
	for(int j=1;j<=slen;j++){if(options==j){
	switch (options){
	...
	System.out.println("Enter the expense youneed to search:\t");
	Scanner sc = new Scanner(System.in);
	int val = sc.nextInt();
	 if(arrlist.contains(val)) {
	   ...
	   System.err.println("Found at the Index of "+arrlist.indexOf(val)+" In the Array List..\n");
		...
		System.out.println("Oh..! It seems Your Expenditure Doesn'tExixted");
	}
	...
	public static void main(String[] args) {
		...
		errorHandle.optionsSelection();// TODO Auto-generated method stub
